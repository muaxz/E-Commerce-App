...
export default function NotifyWindow(props:Props){
    ...
    return(
        <div>
            ...
            <div className={`border-2 border-solid  max-w-lg w-full duration-500 bg-green-400 h-64 fixed left-2/4 ${props.isActive ? "top-2/4" : "top-1/4"}  -translate-y-1/4 -translate-x-2/4 ${props.isActive ? "opacity-100" : "opacity-0"} ${props.isActive ? "z-40" : "-z-1"} flex items-center`}>
