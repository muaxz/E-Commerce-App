    ...
    return(
        ...
        {loading ? "loading" : ( <div className='pt-40 pb-20 rounded-mb'>
            <div className='w-full max-w-7xl shadow-2xl m-auto rounded-xl'>
                <div className="flex ">
                    <div className="w-80 h-96 bg-yellow-400 text-center rounded-2xl">
                        ...
                        <div onClick={()=>setIsDetailOpen(!isDetailOpen)} className="cursor-pointer   mt-1">
                            ...
                            <FontAwesomeIcon className="pt-2 text-white" icon={faAngleDown}></FontAwesomeIcon>
                        </div>
                    </div>
                ...
                <div className={`pt-10 pl-9 rounded-bl-xl rounded-br-xl duration-200 bg-red-400 ${isDetailOpen ? "h-128 min-h-full" : "h-0"} ${isDetailOpen ? "overflow-visible": "overflow-hidden"}`}>
                    <div className="pt-10">
